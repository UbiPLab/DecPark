...
public class Locations {
    ...
    public static IssuerKeyPair initIssuer(URI baseLocation, String baseUri,
            URI iskLocation, URI ipkLocation, URI ipkUri) throws URISyntaxException {
    ...
    public static IssuerKeyPair initIssuer(URI spLocation, String spUri,
            ...
            URI ipkUri) throws URISyntaxException {
    ...
    public static IssuerKeyPair initIssuer(URI spLocation, String spUri,
            URI gpLocation, String gpUri, URI iskLocation, URI ipkLocation,
            URI ipkUri, Integer numOfAttributes, Integer epochLength) throws URISyntaxException {
        if (epochLength == null) {
    ...
    public static final VEPrivateKey initTrustedParty(URI spId,
            URI veskLocation, URI vepkLocation, URI vepkId) throws URISyntaxException {
