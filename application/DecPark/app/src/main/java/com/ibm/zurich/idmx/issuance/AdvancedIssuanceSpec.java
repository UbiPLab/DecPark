 ...
 */
public class AdvancedIssuanceSpec {

    /** Index of the public key base where the master secret is signed. */
    public static final int MASTER_SECRET_INDEX = 0;
    /** Index of the public key base where the smartcard secret is signed. */
    public static final int SMARTCARD_SECRET_INDEX = 0;
    ...
    public static final String SMARTCARD_SECRET = "smartcard_secret;";
    ...
    private final String tempNameOfCredInProof;
     ...
     */
    public AdvancedIssuanceSpec(final URI ipkId, final URI theCredStructLocation,
                                final String tempNameOfCredInProof,
                                final ProofSpec spec) {
        issuerPublicKeyId = ipkId;
        credStructLocation = theCredStructLocation;
        this.spec = spec;
        this.tempNameOfCredInProof = tempNameOfCredInProof;
    ...
    public String getTempNameOfCredInProof() {
      return tempNameOfCredInProof;
    }
}
