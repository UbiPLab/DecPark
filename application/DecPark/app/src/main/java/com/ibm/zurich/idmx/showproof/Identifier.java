...
public class Identifier {
    ...
    public final void setValue(final BigInteger theValue) {
        if (value == null ) {
          value = theValue;
        } else if (! value.equals(theValue)) {
          throw new RuntimeException("Incompatible values for identifiers. New value: " + theValue + " old value: " + value + " Id: "+ this);
        }
    }
  ...
  public String toString() {
    return "Identifier [name=" + name + ", dataType=" + dataType + ", proofMode=" + proofMode
        + ", rand=" + rand + ", attr=" + attr + ", credentialStructureId=" + credentialStructureId
        + ", issuerPublicKeyId=" + issuerPublicKeyId + ", attributeName=" + attributeName
        + ", value=" + value + "]";
  }
