...
public abstract class Actor implements Serializable {
    ...
    protected boolean verifyRegistrationProof(BlockchainObject registrationRecord, BigInteger nonce) {
       ...
       Log.e("verify registration","Verify registration record: " + res);
        return res;
    }
    ...
    protected boolean verifyAuthenticationRecord(BlockchainObject authenticationRecord,
        ...
        Log.e("verify ticket","Verify ticket: " + ticketValidateResult);
        ...
        if (ticketValidateResult) {
            ...
            Log.e("Verify policy","Verify fullfilment policy: " + fullfilmentPolicyResults);
            ...
            Log.e("successful","Verify Authenticate Proof successful" );
