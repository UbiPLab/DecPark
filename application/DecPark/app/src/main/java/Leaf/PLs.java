...
public class PLs {
    ...
    public static ArrayList<PLs> parseInfoFromInputFile(String inputFilePath, int rowBegin, int rowEnd) throws IOException {
        ...
        int lastRowNum = rowEnd; //获取表格内容的最后一行的行数
    ...
    public static void main(String[] args) throws IOException {
        ArrayList<PLs> pl_list = parseInfoFromInputFile("E:\\zmw\\AndroidTool\\AndroidProject\\DecPark\\app\\src\\main\\java\\keystore\\LosAngelParkingLots.xlsx", 46,61);
